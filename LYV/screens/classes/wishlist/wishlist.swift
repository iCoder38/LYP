...
//  LYV
//
//  Created by Dishant Rajput on 12/03/25.
//
...
class wishlist: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.lbl_nav.text = String("Wishlist")
...
extension wishlist: UICollectionViewDelegate ,
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "wishlist_view_cell2", for: indexPath as IndexPath) as! wishlist_view_cell2

            let item = self.arr_category_products[indexPath.row] as? [String:Any]
           
            cell.lbl_price.text = "$\(item!["productPrice"]!)"
            cell.img_details.text = "\(item!["productName"]!)"
            
            cell.img_product_image.sd_imageIndicator = SDWebImageActivityIndicator.grayLarge
            cell.img_product_image.sd_setImage(with: URL(string: (item!["productImage"] as! String)), placeholderImage: UIImage(named: "1024"))
            
            cell.configure(with: "\(item!["productcolor"]!)")
...
class wishlist_view_cell: UICollectionViewCell , UITextFieldDelegate {
...
class wishlist_view_cell2: UICollectionViewCell {
